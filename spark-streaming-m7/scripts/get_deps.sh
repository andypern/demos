...
cp -f /mapr/maprdemo/demos/spark-streaming-m7/conf/hive-site.xml /opt/mapr/hive/hive-0.12/conf/hive-site.xml
cp -f /mapr/maprdemo/demos/spark-streaming-m7/conf/shark-env.sh /opt/mapr/shark/shark-0.90/conf/shark-env.sh
cp -f /mapr/maprdemo/demos/spark-streaming-m7/conf/run /opt/mapr/shark/shark-0.90/run
