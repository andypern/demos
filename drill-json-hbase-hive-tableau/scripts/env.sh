...
alias demo-drillbit-restart='clush -a "/opt/mapr/drill/drill-1.0.0/apache-drill-1.0.0-m2-incubating-SNAPSHOT/bin/drillbit.sh restart"'
...
alias demo-hive-select='${SQLLINE} --run=${DRILL_DEMODIR}/scripts/hive_purchases.sql'
